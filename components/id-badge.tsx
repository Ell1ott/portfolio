...
import { useGLTF, useTexture, Environment, Lightformer, Text, Svg } from '@react-three/drei'
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const [nzTime, setNzTime] = useState(new Intl.DateTimeFormat('en-NZ', options).format(new Date()))
